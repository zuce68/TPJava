...
public class Maclasse {
    ...
    public static void main(String[] arguments)
    {
        while (true)
        {
            ...
            int fin = JOptionPane.showOptionDialog(null,"Fin","Votre choix",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,options,options[0]);

            switch(fin) {
                case 0 : {System.out.println("Nouvelle Saisier");break;}
                case 1 : {System.out.println("Terminer");endProcess(nomPrenom,age);break;}
            }
        }
    }
